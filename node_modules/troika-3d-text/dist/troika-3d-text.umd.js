(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('troika-worker-utils'), require('troika-three-utils'), require('troika-3d')) :
  typeof define === 'function' && define.amd ? define(['exports', 'three', 'troika-worker-utils', 'troika-three-utils', 'troika-3d'], factory) :
  (global = global || self, factory(global.troika_3d_text = {}, global.THREE, global.troika_worker_utils, global.troika_three_utils, global.troika_3d));
}(this, (function (exports, three, troikaWorkerUtils, troikaThreeUtils, troika3d) { 'use strict';
  ...
  */
  var GlyphsGeometry = /*@__PURE__*/(function (InstancedBufferGeometry) {
     ...
     */
    GlyphsGeometry.prototype.updateGlyphs = function updateGlyphs (glyphBounds, glyphAtlasIndices, totalBounds, chunkedBounds) {
  ...
  var tempMat4$1 = new three.Matrix4();
  ...
  var SelectionManagerFacade = /*@__PURE__*/(function (ListFacade) {
    function SelectionManagerFacade (parent, onSelectionChange) {
      ...
      var onDragStart = function (e) {
        ...
        if (textRenderInfo) {
          var localPoint = e.intersection.point.clone().applyMatrix4(tempMat4$1.getInverse(textMesh.matrixWorld));
          var caret = getCaretAtPoint(textRenderInfo, localPoint.x, localPoint.y);
          if (caret) {
      ...
      var onDrag = function (e) {
        ...
        if (e.ray && textRenderInfo) {
          ...
          var ray = e.ray.clone().applyMatrix4(tempMat4$1.getInverse(textMesh.matrixWorld));
          var localPoint = ray.intersectPlane(tempPlane.setComponents(0, 0, 1, 0), tempVec3$1);
          if (localPoint) {
            var caret = getCaretAtPoint(textRenderInfo, localPoint.x, localPoint.y);
            if (caret) {
